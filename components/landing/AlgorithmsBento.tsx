    ...
    <section id="modules" className="w-full max-w-[1400px] mx-auto px-4 sm:px-8 py-16 md:py-24 relative z-10">
      ...
      >
        ...
        <MotionLink 
          ...
          href="/learn" 
          className="md:col-span-4 lg:col-span-4 min-h-[250px] md:min-h-[300px] group bg-brand-bg-card border border-brand-border md:hover:border-brand-purple/50 transition-colors flex flex-col justify-end p-6 md:p-8 relative overflow-hidden rounded-2xl" 
        >
          <div className="absolute top-0 right-0 w-64 h-64 md:w-96 md:h-96 bg-brand-purple/5 rounded-full blur-3xl -z-10 md:group-hover:bg-brand-purple/10 transition-colors" />
        ...
        <MotionLink 
          variants={cardVariants}
          href="/sort" 
          className="md:col-span-2 lg:col-span-2 md:row-span-2 bg-brand-bg-card border border-brand-border md:hover:border-brand-green/50 transition-colors p-6 md:p-8 flex flex-col relative rounded-2xl overflow-hidden group"
        >
          <div className="flex-grow z-10 relative">
            <h3 className="text-xl md:text-2xl font-bold mb-2 md:group-hover:text-brand-green transition-colors font-serif">Parallel Sorting</h3>
          ...
          <div className="mt-8 flex gap-1 items-end h-24 md:h-32 opacity-40 md:group-hover:opacity-100 transition-opacity relative z-10">
        ...
        <MotionLink 
          variants={cardVariants}
          href="/pathfinding" 
          className="md:col-span-2 lg:col-span-2 min-h-[180px] bg-brand-bg-card border border-brand-border md:hover:border-brand-cyan/50 transition-colors p-6 flex flex-col justify-between rounded-2xl group"
        >
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-1 md:group-hover:text-brand-cyan transition-colors">Graph Engine Hooks</h3>
          ...
          <div className="text-brand-cyan mt-4 opacity-70 md:group-hover:opacity-100 transition-opacity">
        ...
        <MotionLink 
          variants={cardVariants}
          href="/automata" 
          className="md:col-span-2 lg:col-span-2 min-h-[180px] bg-brand-bg-card border border-brand-border md:hover:border-brand-yellow/50 transition-colors p-6 flex flex-col justify-between rounded-2xl group"
        >
          <div>
            <h3 className="text-lg md:text-xl font-bold mb-1 md:group-hover:text-brand-yellow transition-colors">Machine Learning</h3>
          ...
          <div className="text-brand-yellow mt-4 opacity-70 md:group-hover:opacity-100 transition-opacity">
         ...
         <MotionLink 
          variants={cardVariants}
          href="/graphs" 
          className="md:col-span-2 lg:col-span-3 min-h-[120px] bg-brand-bg-card border border-brand-border md:hover:border-brand-purple/50 transition-colors p-5 md:p-6 flex items-center gap-4 md:gap-6 rounded-2xl group"
        >
          ...
          <div>
            <h3 className="text-base md:text-lg font-bold md:group-hover:text-brand-purple transition-colors">Topological Data</h3>
        ...
        <MotionLink 
          variants={cardVariants}
          href="/linked-lists" 
          className="md:col-span-2 lg:col-span-3 min-h-[120px] bg-brand-bg-card border border-brand-border md:hover:border-brand-rose/50 transition-colors p-5 md:p-6 flex items-center gap-4 md:gap-6 rounded-2xl group"
        >
          ...
          <div>
            <h3 className="text-base md:text-lg font-bold md:group-hover:text-brand-rose transition-colors">Memory References</h3>
